...
function twentyseventeen_customize_register( $wp_customize ) {
	 ...
	 * Barra superior.
	 */
	$wp_customize->add_section( 'barra', array(
		'title'    => __( 'Barra superior', 'twentyseventeen' ),
		'priority' => 130, // Before Additional CSS.
	) );

	$wp_customize->add_setting( 'correo1', array(
		'default'			=> '',
		'transport'         => 'refresh',
	) );

	$wp_customize->add_control( 'correo1', array(
		'label'       => __( 'correo 1', 'twentyseventeen' ),
		'section'     => 'barra',
		'type'        => 'input',
		'description' => __( 'Escriba el correo de su preferencia')
	) );

	
	$wp_customize->add_setting( 'correo2', array(
		'default'			=> '',
		'transport'         => 'refresh',
	) );

	$wp_customize->add_control( 'correo2', array(
		'label'       => __( 'correo 2', 'twentyseventeen' ),
		'section'     => 'barra',
		'type'        => 'input',
		'description' => __( 'Escriba el correo de su preferencia')
	) );
